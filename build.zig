...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("langnet_spec", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "langnet_spec" is the name you will use in your source code to
                // import this module (e.g. `@import("langnet_spec")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "langnet_spec", .module = mod },
            },
        }),
    });
    ...
    // Create shared protobuf module first
    const zig_protobuf_module = b.addModule("protobuf", .{
        .root_source_file = b.path("zig-protobuf/src/protobuf.zig"),
        .target = target,
        .optimize = optimize,
    });
